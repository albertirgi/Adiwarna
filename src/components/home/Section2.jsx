      ...
      <div className="bg-2-1 h-screen relative w-full bg-no-repeat bg-contain bg-center snap-start">
        <div className="flex flex-row justify-end pt-40">
          <div className="basis-7/12 flex justify-end">
            <h1 className="text-custom-white font-jakarta-sans text-6xl font-bold pr-20">
              timeline
            </h1>
          </div>
            ...
            <div className="flex flex-row">
              ...
              <div className="basis-4/4 flex">
                <div className="flex flex-col pt-3">
                  <h1 className="text-custom-white font-jakarta-sans text-3xl mb-16">
                    pre-kelana
                  </h1>
                  <h1 className="text-custom-white font-jakarta-sans text-3xl mb-16">
                    roadshow
                  ...
                  <h1 className="text-custom-white font-jakarta-sans text-3xl">
                    exhibition
                  </h1>
                </div>
              </div>
        ...
        <div className="flex flex-col justify-end pt-8">
          <div className="w-full h-16 bg-[#FA0202] border-y-4 border-y-white marquee-container">
            <div className="flex flex-row items-center h-full justify-evenly marquee-content">
              <h1 className="text-custom-white font-jakarta-sans text-2xl font-bold">
                upcoming{" "}
                <span className="text-custom-white font-jakarta-sans text-2xl font-normal italic">
                  event
                </span>
              </h1>
              <img src={LogoKelanaOnly} />
              <h1 className="text-custom-white font-caslon-text text-2xl font-normal italic">
                upcoming{" "}
                <span className="text-custom-white font-jakarta-sans text-2xl font-normal">
                  event
                </span>
              </h1>
              <img src={LogoKelanaOnly} />
              ...
              <h1 className="text-custom-white font-jakarta-sans text-2xl font-bold">
                upcoming{" "}
                <span className="text-custom-white font-caslon-text text-2xl font-normal italic">
                  event
                </span>
              </h1>
              <img src={LogoKelanaOnly} />
          ...
          <div className="flex flex-col px-64 pt-12">
            <h1 className="text-custom-white font-jakarta-sans text-6xl font-bold">
              upcoming{" "}
              <span className="text-custom-white font-caslon-text text-6xl font-normal italic">
                event
              </span>
            </h1>
            <div className="flex flex-row pt-12 justify-between">
              <div className="w-[23rem]">
                <div className="flex flex-col">
                  ...
                  <h1 className="text-custom-white font-jakarta-sans text-4xl font-bold mt-8">
                    nama event
                  </h1>
                  <p className="text-custom-white font-jakarta-sans text-sm">
