                ...
                <div className="flex">
                  ...
                  <div className="w-[65%]">
                    <p className="font-semilight font-jakarta-sans text-custom-purple text-justify lg:text-[0.8em] xl:text-[1em]">
                      Photography is a powerful medium for self-celebration and authentic self-expression. However, there are some individuals who struggle to articulate their vision for their portrait sessions and often resulting in images that do not fully represent their personality or identity.
                      The aim of designing a media guide for studio portrait photography based on personality is to ensure the final images reflect the client's vision of how they wish to be portrayed. This guide employs the 5W1H approach (Who, What, When, Where, Why, and How), along with interviews
                      and observations of past experiences. The result is a guide that serves as inspiration for those uncertain about the conceptual direction of their portrait photoshoot, helping to capture images that truly express their individuality.
                    </p>
                  </div>
                </div>
              </div>
