            ...
            <article className="flex flex-col w-[33%] relative">
              <div className="flex flex-col grow text-custom-purple hover:cursor-pointer">
                <Link to="1">
                  ...
                  <h2 className="font-jakarta-sans font-semibold text-justify leading-tight text-[12px] mt-2 lg:text-2lg xl:mt-3 xl:text-2xl">Kalkulaku</h2>
                  <p className="font-caslon-condensed font-light italic text-[8px] lg:text-1lg lg:mt-1 xl:text-1xl xl:mt-2">Monica Yvetta Utomo</p>
                </Link>
              </div>
            </article>
            <article className="flex flex-col w-[33%] mx-4 lg:mx-8 xl:mx-10 relative">
              <div className="flex flex-col grow text-custom-purple hover:cursor-pointer">
                <Link to="2">
                  ...
                  <h2 className="font-jakarta-sans font-semibold text-justify leading-tight text-[12px] mt-2 lg:text-2lg xl:mt-3 xl:text-2xl">Petallete</h2>
                  <p className="font-caslon-condensed font-light italic text-[8px] lg:text-1lg lg:mt-1 xl:text-1xl xl:mt-2">Vanessa Tan</p>
                </Link>
              </div>
            </article>
            <article className="flex flex-col w-[33%] relative">
            ...
            <article className="flex flex-col w-[33%] relative">
              <div className="flex flex-col grow text-custom-purple hover:cursor-pointer">
                <Link to="4">
                  ...
                  <h2 className="font-jakarta-sans font-semibold lg:text-justify leading-tight text-[12px] mt-2 lg:text-2lg xl:mt-3 xl:text-2xl">Harmony Inside & Out</h2>
                  <p className="font-caslon-condensed font-light italic text-[8px] lg:text-1lg lg:mt-1 xl:text-1xl xl:mt-2">Michelle Aldorino</p>
                </Link>
              </div>
            </article>
            <article className="flex flex-col w-[33%] mx-4 lg:mx-8 xl:mx-10 relative">
              <div className="flex flex-col grow text-custom-purple hover:cursor-pointer">
                <Link to="5">
                  ...
                  <h2 className="font-jakarta-sans font-semibold lg:text-justify leading-tight text-[12px] mt-2 lg:text-2lg xl:mt-3 xl:text-2xl">7 Broomsticks Bindery </h2>
                  <p className="font-caslon-condensed font-light italic text-[8px] lg:text-1lg lg:mt-1 xl:text-1xl xl:mt-2">Patricia Chamora</p>
                </Link>
              </div>
            </article>
            <article className="flex flex-col w-[33%] relative">
              <div className="flex flex-col grow text-custom-purple hover:cursor-pointer">
                <Link to="6">
                  ...
                  <h2 className="font-jakarta-sans font-semibold text-justify leading-tight text-[12px] mt-2 lg:text-2lg xl:mt-3 xl:text-2xl">Personality Photoshoot</h2>
                  <p className="font-caslon-condensed font-light italic text-[8px] lg:text-1lg lg:mt-1 xl:text-1xl xl:mt-2">Gwyneth Charlize</p>
                </Link>
              </div>
            </article>
          </div>
