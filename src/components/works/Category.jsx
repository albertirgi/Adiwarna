...
const Category = () => {
  ...
  return (
    <div>
      <FixNavbar />
      <div className="bg-category bg-no-repeat bg-cover pb-20 lg:h-[2300px] lg:px-14 xl:px-20">
        <div className="flex relative flex-col w-full mx-auto max-w-[390px] lg:max-w-[1024px] xl:max-w-[1440px]">
          <div className="flex flex-1 items-center justify-between mt-16 lg:mt-28">
            <div className="flex">
              <img src={Dot} className="hidden lg:block lg:mr-5 xl:mr-9" />
              <Link to="/category">
                <span className="font-medium font-jakarta-sans text-custom-purple text-[2em] lg:text-[1.3em] xl:text-[1.7em] mr-2">
                  currated
                </span>
                <span className="italic font-medium font-caslon-condensed text-custom-purple text-[2em] lg:text-[1.3em] xl:text-[1.7em]">
                  works
                </span>
              </Link>
            </div>
            <div>
              <p className="hidden lg:block font-semilight font-caslon-condensed italic text-custom-purple lg:text-[1.3em] xl:text-[1.7em]">
                Category
              </p>
            </div>
          </div>
          <div className="absolute flex flex-col relative">
            <div className="relative flex flex-col">
              <div className="flex self-end mt-10 lg:mt-10 xl:mt-10">
                <p className="self-end font-bold font-jakarta-sans text-custom-purple mr-2 lg:mr-4 lg:text-[2em] xl:mr-5 xl:text-[3em]">
                  <Link to="/category/thesis">Thesis</Link>
                </p>
                <Link to="/category/thesis">
                  <img src={Thesis} className="w-[200px] lg:h-[350px] lg:w-[460px] xl:h-[480px] xl:w-[590px]" />
                </Link>
              </div>

              <div className="flex self-end mt-10 lg:mt-32 xl:mt-40">
                <div className="absolute relative flex flex-col">
                  <Link to="/category/brand-and-product-innovation">
                    <img src={Brand} className="w-[240px] lg:h-[250px] lg:w-[460px] xl:h-[380px] xl:w-[710px]" />
                  </Link>
              ...
              <div className="flex self-end mt-10 lg:mt-28 xl:mt-20">
                <div className="flex flex-col self-end mr-2 lg:mr-4 xl:mr-5">
                ...
                <Link to="/category/digital-media">
                  <img src={Digital} className="w-[115px] lg:h-[330px] lg:w-[250px] xl:h-full xl:w-[375px]" />
                </Link>
              </div>

              <div className="absolute mt-[150px] lg:mt-[300px] xl:mt-[400px]">
                <Link to="/category/campaign-strategy">
                  <img src={Campaign} className="w-[100px] lg:h-[330px] lg:w-[250px] xl:h-[540px] xl:w-[375px]" />
                </Link>
                <div className="relative flex flex-col">
                  <p className="self-end font-bold font-jakarta-sans text-custom-purple lg:text-[2em] xl:text-[3em]">
              ...
              <div className="absolute flex mt-[400px] lg:mt-[800px] xl:mt-[1225px]">
                <Link to="/category/graphic-design">
                  <img src={Graphic} className="w-[150px] lg:h-[340px] lg:w-[340px] xl:h-[380px] xl:w-full" />
                </Link>
                <div className="flex self-end relative flex-col ml-2 lg:ml-4 xl:ml-5">
