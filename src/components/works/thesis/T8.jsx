                ...
                <div className="flex">
                  ...
                  <div className="w-[70%]">
                    <p className="font-semilight font-jakarta-sans text-custom-purple text-justify lg:text-[0.8em] xl:text-[1em] mb-3">
                      ...
                      seorang fashion photographer, menghadapi dilema dalam menyusun konsep untuk dua brand dengan produk serupa. Ini menunjukkan perlunya guideline untuk meningkatkan efektivitas fotografer dalam mengeksekusi konsep photoshoot. Guideline yang baik harus sesuai dengan workflow
                      fotografer, membantu mereka memahami brand dan menyusun konsep yang memenuhi kebutuhan klien. Penelitian ini bertujuan membuat guideline strategi fashion photoshoot untuk dua brand dengan produk serupa. Dengan metode kualitatif komparatif, penulis membandingkan workflow mentor
                      magang dalam menyusun konsep untuk brand Frio dan First Time Round (FTR), menggunakan indikator kerangka pemikiran.
                    </p>
                  </div>
                </div>
              </div>
