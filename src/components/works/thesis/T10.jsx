...
import Mobile1 from "../../../assets/images/works/thesis/T10/mobile/1.webp";
import Mobile2 from "../../../assets/images/works/thesis/T10/mobile/2.webp";
import Mobile3 from "../../../assets/images/works/thesis/T10/mobile/3.webp";
                  ...
                  <div className="flex">
                    ...
                    <div className="w-[70%]">
                      <p className="font-semilight font-jakarta-sans text-custom-purple text-justify lg:text-[0.8em] xl:text-[1em] mb-3">
                        ...
                        tinggi dan cukup menarik. Namun sebuah logo tidak hanya menunjukan keindahan estetika saja, melaikan karakteristik dan nilai citra brand dalam strategi positioning brand. Penelitian ini bertujuan untuk mengetahui apakah logo yang dibuat menggunakan artificial intelligence
                        dapat menunjukan karakteristik, nilai dan citra brand dibandingkan dengan logo brand yang dibuat secara manual. Brand yang digunakan untuk pembahasan penelitian merupakan brand Sentra Kuningan Mojotrisno yang telah memiliki strategi branding yang matang. Metode penelitian
                        yang digunakan merupakan metode jenis kualitatif phenomenology deskriptif dengan analisis menggunakan teori semiotika visual C. S. Pierce.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-col lg:hidden">
            <div className="flex mt-8">
              <div className="w-full h-full flex flex-col">
                <p className="font-bold font-jakarta-sans text-custom-purple leading-tight text-[12px] mt-2 mb-2 pr-2">Analisis Komparasi Strategi Visual Branding Logo Mojotrisno Sentra Kuningan dengan Logo yang dibuat oleh Artificial Intelligence.</p>
                <div className="flex flex-col">
                  <p className="font-extralight font-caslon-condensed text-custom-purple text-[8px] mb-1">Renata Agustine Putri Pratama</p>
                  <div className="flex">
                    <img src={Email} className="flex justify-between items-start text-center w-[3%] mr-1" />
                    <p className="font-extralight italic font-caslon-condensed text-custom-purple text-[7px]">renataagustine12@gmail.com</p>
                  </div>
                  <div className="flex">
                    <img src={LinkedIn} className="flex justify-between items-start text-center w-[3%] mr-1" />
                    <p className="italic font-extralight font-caslon-condensed text-custom-purple text-[7px]">Renata Agustine</p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col pl-10 mt-2">
              <p className="font-semilight font-jakarta-sans text-custom-purple text-justify text-[8px]">
                Di era digital ini, terdapat banyak platform situs website yang menawarkan jasa pembuatan logo secara instant menggunakan artificial intelligence. Dari beberapa hasil penelitian mengatakan bahwa logo buatan artificial intelligence secara visual memiliki nilai estetika yang tinggi dan
                cukup menarik. Namun sebuah logo tidak hanya menunjukan keindahan estetika saja, melaikan karakteristik dan nilai citra brand dalam strategi positioning brand. Penelitian ini bertujuan untuk mengetahui apakah logo yang dibuat menggunakan artificial intelligence dapat menunjukan
                karakteristik, nilai dan citra brand dibandingkan dengan logo brand yang dibuat secara manual. Brand yang digunakan untuk pembahasan penelitian merupakan brand Sentra Kuningan Mojotrisno yang telah memiliki strategi branding yang matang. Metode penelitian yang digunakan merupakan
                metode jenis kualitatif phenomenology deskriptif dengan analisis menggunakan teori semiotika visual C. S. Pierce.
              </p>

              <p className="font-semilight font-jakarta-sans text-custom-purple text-justify text-[8px] mt-2">
                Hasil penelitian menunjukan bahwa hasil logo dari ke 5 platform artificial intelligence logo generator masih kurang kreatif atau bervariasi secara bentuk, warna dan tipografi dibandingkan logo manual. Artificial intelligence logo generator cenderung menghasilkan logo dari simbol/ikon
                atau desain logo yang pernah ada atau banyak digunakan sebelumnya. Hal ini menunjukan bahwa logo yang dibuat oleh artificial intelligence masih belum dapat menggambarkan karakteristik keunikan brand Sentra Kuningan Mojotrisno.
              </p>
