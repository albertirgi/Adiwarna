                ...
                <div className="flex">
                  ...
                  <div className="w-[70%]">
                    <p className="font-semilight font-jakarta-sans text-custom-purple text-justify lg:text-[0.8em] xl:text-[1em]">
                      ...
                      untuk meningkatkan kualitas kopi Indonesia menjadi specialty coffee. Cerita Nusa, sebuah start up yang didirikan pada tahun 2023, bertujuan untuk meningkatkan apresiasi kopi Indonesia melalui berbagai cara, yaitu meningkatkan pengetahuan masyarakat tentang specialty coffee dari
                      produk kami, memberikan pengalaman baru dalam menyeduh kopi drip bag dengan tambahan bahan pendukung untuk meningkatkan pengalaman rasa, memperkenalkan budaya dan adat Indonesia melalui kopi, serta dari rangkaian produk kopi dari berbagai daerah Indonesia, agar pengalaman
                      tersebut lebih maksimal dengan harapan pembeli bisa mengalami betapa kayanya budaya yang dibentuk karena kopi, uniknya tiap jenis, proses, dan varietas kopi yang di tanam dan dikembangkan Indonesia.
                    </p>
                  </div>
                </div>
              </div>
