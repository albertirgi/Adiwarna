...
import Profile from "../../../assets/images/works/brandProduct/BP2/bp2-1.webp";
import Picture1 from "../../../assets/images/works/brandProduct/BP2/1.webp";
import Picture2 from "../../../assets/images/works/brandProduct/BP2/2.webp";
import Picture3 from "../../../assets/images/works/brandProduct/BP2/3.webp";
import Picture4 from "../../../assets/images/works/brandProduct/BP2/4.webp";
import Picture5 from "../../../assets/images/works/brandProduct/BP2/5.webp";
import Mobile1 from "../../../assets/images/works/brandProduct/BP2/mobile/1.webp";
import Mobile2 from "../../../assets/images/works/brandProduct/BP2/mobile/2.webp";
import Mobile3 from "../../../assets/images/works/brandProduct/BP2/mobile/3.webp";
import Mobile4 from "../../../assets/images/works/brandProduct/BP2/mobile/4.webp";
import Mobile5 from "../../../assets/images/works/brandProduct/BP2/mobile/5.webp";
        ...
        <div className="flex relative flex-col w-full mx-auto lg:max-w-[1024px] xl:max-w-[1440px]">
          ...
          <div className="hidden lg:block">
                  ...
                  <div className="flex">
                    ...
                    <div className="w-[70%]">
                      <p className="font-semilight font-jakarta-sans text-custom-purple text-justify lg:text-[0.8em] xl:text-[1em]">
                        ...
                        sebagai media edukasi untuk memperkenalkan 20 jenis rempah-rempah di Indonesia. Amborasa merupakan singkatan dari “Amboja Rempah Nusantara”. Kata “Amboja” diambil dari bahasa Sansekerta yang bermakna menjamu makanan. Secara keseluruhan, “Amborasa” artinya adalah menjamu
                        makanan yang kaya akan rempah Nusantara. Board game ini dapat dimainkan oleh 2-4 pemain secara individu dan 1 orang game master dengan durasi di atas 45 menit.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex gap-16 lg:mb-5 xl:mb-7">
              ...
              <div className="w-[50%]">
                <p className="font-semilight font-jakarta-sans text-custom-purple text-justify lg:text-[0.8em] xl:text-[1em]">
                  Secara garis besar, board game Amborasa mengajak para pemain untuk menjamu idola favorit mereka dengan hidangan khas Indonesia yang penuh rempah. Para pemain didorong untuk mengenali berbagai rempah yang dijual dan yang akan digunakan untuk ‘memasak’ sesuai resep yang diambil.
                  Karena stok sangat terbatas, para pemain harus menawar harga setinggi-tingginya demi mendapatkan rempah yang diinginkan. Selain menawarkan interaksi langsung dengan miniatur replika rempah-rempah, Amborasa juga memberikan edukasi seputar bahan-bahan masakan serta teknik dasar
                  pengolahan rempah yang berbeda-beda.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:hidden">
            <div className="flex mt-8">
              <div className="w-full h-full flex flex-col">
                <p className="font-bold font-jakarta-sans text-custom-purple leading-tight text-[12px] mt-2">Amborasa</p>
                <a href="https://drive.google.com/drive/folders/1iKccJ92r2YPDK5fITrGUQhFIon44hh1W" target="_blank" rel="noreferrer">
                ...
                <div className="flex flex-col">
                  <p className="font-extralight font-caslon-condensed text-custom-purple text-[8px] mb-1">Fiorella Chelsea</p>
                  <div className="flex">
                    <img src={Email} className="flex justify-between items-start text-center w-[3%] mr-1" />
                    <p className="font-extralight italic font-caslon-condensed text-custom-purple text-[7px]">fiorellachelsea5@gmail.com</p>
                  </div>
                  <div className="flex">
                    <img src={LinkedIn} className="flex justify-between items-start text-center w-[3%] mr-1" />
                    <p className="italic font-extralight font-caslon-condensed text-custom-purple text-[7px]">Fiorella Chelsea</p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col pl-10 mt-2">
              <p className="font-semilight font-jakarta-sans text-custom-purple text-justify text-[8px]">
                Rempah-rempah merupakan warisan budaya Indonesia yang masih digunakan hingga saat ini. Namun, masih banyak Generasi Z yang kurang mengenal rempah-rempah karena mereka jarang melihat dan menggunakannya secara langsung selama beraktivitas. Karena itu, board game Amborasa hadir sebagai
                media edukasi untuk memperkenalkan 20 jenis rempah-rempah di Indonesia. Amborasa merupakan singkatan dari “Amboja Rempah Nusantara”. Kata “Amboja” diambil dari bahasa Sansekerta yang bermakna menjamu makanan. Secara keseluruhan, “Amborasa” artinya adalah menjamu makanan yang kaya
                akan rempah Nusantara. Board game ini dapat dimainkan oleh 2-4 pemain secara individu dan 1 orang game master dengan durasi di atas 45 menit.
              </p>
              ...
              <div className="flex flex-col gap-2 mt-2">
                <div>
                  <img src={Mobile1} className="flex justify-between items-start text-center w-[80%]" />
                </div>
                <div className="flex gap-2">
                  <div className="flex flex-col w-[70%] items-end gap-2">
                    <img src={Mobile2} className="flex justify-between items-start text-center w-[100%]" />
                    <img src={Mobile3} className="flex justify-between items-start text-center w-[60%]" />
                  </div>
                  <div className="flex flex-col w-[28%] gap-2">
                    <img src={Mobile4} className="flex justify-between items-start text-center w-[100%]" />
                    <img src={Mobile5} className="flex justify-between items-start text-center w-[100%]" />
                  </div>
                </div>
                <div className="w-full flex items-end justify-end mt-1 mb-4">
