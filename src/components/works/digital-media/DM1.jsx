...
import Mobile1 from "../../../assets/images/works/digitalMedia/DM1/mobile/1.webp";
import Mobile2 from "../../../assets/images/works/digitalMedia/DM1/mobile/2.webp";
import Mobile3 from "../../../assets/images/works/digitalMedia/DM1/mobile/3.webp";
import Mobile4 from "../../../assets/images/works/digitalMedia/DM1/mobile/4.webp";
import Mobile5 from "../../../assets/images/works/digitalMedia/DM1/mobile/5.webp";
          ...
          <div className="flex flex-col lg:hidden">
            <div className="flex mt-8">
              <div className="w-full h-full flex flex-col">
                <p className="font-bold font-jakarta-sans text-custom-purple leading-tight text-[12px] mt-2">Pinjol Benjol</p>
                <a href="https://drive.google.com/file/d/1J7vwDwQC4zdiv9uDTdTKwWNUuK7EQ1eA/view" target="_blank" rel="noreferrer">
                ...
                <div className="flex flex-col">
                  <p className="font-extralight font-caslon-condensed text-custom-purple text-[8px] mb-1">Katya Jocelyn</p>
                  <div className="flex">
                    <img src={Email} className="flex justify-between items-start text-center w-[3%] mr-1" />
                    <p className="font-extralight italic font-caslon-condensed text-custom-purple text-[7px]">katya.tan@gmail.com</p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col pl-10 mt-2">
              <p className="font-semilight font-jakarta-sans text-custom-purple text-justify text-[8px]">
                Kemajuan teknologi telah mempermudah transaksi dalam kehidupan sehari-hari, terutama melalui layanan fintech seperti pinjaman online. Layanan ini memungkinkan pengguna untuk meminjam dana sementara dengan mudah. Kelompok sosial yang cakap dalam memanfaatkan teknologi dan memiliki
                gaya hidup hedonis didominasi oleh dewasa muda. Dorongan untuk menikmati hidup sering kali membuat mereka menggunakan layanan pinjaman tanpa berpikir panjang. Media sosial juga memicu perasaan FOMO (Fear Of Missing Out) pada dewasa muda, sehingga mereka menggunakan layanan ini untuk
                memenuhi keinginan mereka. Namun, tanpa literasi keuangan yang memadai, pinjaman online dapat menjadi perangkap finansial.
              </p>
              ...
              <div className="flex flex-col gap-2 mt-2">
                <img src={Mobile1} className="flex justify-between items-start text-center w-full" />
                <div className="flex gap-2">
                  <div className="flex flex-col gap-2">
                    <img src={Mobile2} className="flex justify-between items-start text-center w-full" />
                    <img src={Mobile3} className="flex justify-between items-start text-center w-full" />
                  </div>
                  <img src={Mobile4} className="flex justify-between items-start text-center w-[56%]" />
                </div>
                <img src={Mobile5} className="flex justify-between items-start text-center w-[86%]" />
