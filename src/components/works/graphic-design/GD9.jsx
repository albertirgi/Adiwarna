...
import Mobile1 from "../../../assets/images/works/graphicDesign/GD9/mobile/1.webp";
import Mobile2 from "../../../assets/images/works/graphicDesign/GD9/mobile/2.webp";
import Mobile3 from "../../../assets/images/works/graphicDesign/GD9/mobile/3.webp";
import Mobile4 from "../../../assets/images/works/graphicDesign/GD9/mobile/4.webp";
import Mobile5 from "../../../assets/images/works/graphicDesign/GD9/mobile/5.webp";
          ...
          <div className="flex flex-col lg:hidden">
            <div className="flex mt-8">
              <div className="w-full h-full flex flex-col">
                <p className="font-bold font-jakarta-sans text-custom-purple leading-tight text-[12px] mt-2 mb-10">Aku dan Tubuhku</p>
                <div className="flex flex-col">
                  <p className="font-extralight font-caslon-condensed text-custom-purple text-[8px] mb-1">Stefani</p>
                  <div className="flex">
                    <img src={Email} className="flex justify-between items-start text-center w-[3%] mr-1" />
                    <p className="font-extralight italic font-caslon-condensed text-custom-purple text-[7px]">Fani14.SMPKBWS@gmail.com</p>
                  </div>
                  <div className="flex">
                    <img src={LinkedIn} className="flex justify-between items-start text-center w-[3%] mr-1" />
                    <p className="italic font-extralight font-caslon-condensed text-custom-purple text-[7px]">Stefani Handoko</p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col pl-10 mt-2">
              ...
              <div className="flex flex-col gap-2 mt-2">
                ...
                <div className="flex gap-2">
                  <img src={Mobile2} className="flex justify-between items-start text-center w-[49%] h-fit" />
                  <img src={Mobile3} className="flex justify-between items-start text-center w-[49%] h-fit" />
                </div>
                <div className="flex gap-2">
                  <img src={Mobile4} className="flex justify-between items-start text-center w-[49%] h-fit" />
