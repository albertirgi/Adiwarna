...
export const merchs = [
  ...
  { id: 2, name: "Sticker", desc: "Sungondrong dan kawan-kawannya bisa ditempel di buku sampai di laptop buat menemani hari kamu waktu kerja!", price: "20.000", img: sticker, cover: sticker[5].default, uom: "pack", dimension: "S, M, L, XL" },
  { id: 3, name: "Totebag", desc: "Mau ke kampus, ke pantai, atau cuma jalan-jalan santai, totebag ini siap jadi teman setiamu. Banyak kantongnya bikin barang-barang kamu tertata rapi.", price: "100.000", img: totebag, cover: totebag[5].default, uom: "", dimension: "S, M, L, XL" },
  { id: 4, name: "Keychain (L)", desc: "Ini bukan sekadar gantungan kunci, tapi mini-artwork buat hidup kamu! Yang pasti positive vibes abiss.", price: "29.000", img: keychainLarge, cover: keychainLarge[5].default, uom: "pcs", dimension: "Detail listed" },
